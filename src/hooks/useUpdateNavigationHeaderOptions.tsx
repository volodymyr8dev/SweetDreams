    ...
    headerLeft: typeof navigationHeader.headerLeftMethod != 'undefined' ? () => {
      if (typeof navigationHeader.headerLeftMethod != 'undefined') {
        if (navigationHeader.headerRightText) {
          return (
            <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', paddingRight: 30, paddingLeft: navigationHeader.buttonPaddingLeft ? navigationHeader.buttonPaddingLeft : 0}} onPress={() => navigationHeader.headerLeftMethod() }>
